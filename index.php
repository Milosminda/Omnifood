...
<html lang="en">
	<head>
		...
		<link rel="apple-touch-icon" sizes="180x180" href="resources/fevicons/apple-touch-icon.png">
		<link rel="icon" type="image/png" sizes="32x32" href="resources/fevicons/favicon-32x32.png">
		<link rel="icon" type="image/png" sizes="16x16" href="resources/fevicons/favicon-16x16.png">
		<link rel="manifest" href="resources/fevicons/site.webmanifest">
		<link rel="mask-icon" href="resources/fevicons/safari-pinned-tab.svg" color="#5bbad5">
		<link rel="shortcut icon" href="resources/fevicons/favicon.ico">
		<meta name="msapplication-TileColor" content="#2d89ef">
		<meta name="msapplication-config" content="resources/fevicons/browserconfig.xml">
	...
	<body>
			...
			<nav>
				<div class="row">
					...
					<a class="mobile-nav-icon js--nav-icon">
						<ion-icon class="menu-sharp" name="menu-sharp"></ion-icon>
						<ion-icon class="close-sharp" name="close-sharp"></ion-icon>
					</a>
				</div>
			</nav>
		...
		<section class="section-features js--section-features" id="features">
			...
			<div class="row js--wp-1">
				...
				<div class="col span-1-of-4 box">
					<ion-icon name="alarm-outline" class="icon-big"></ion-icon>
			...
			<div class="row js--wp-3">
				<div class="col span-1-of-4 box">
					...
					<div class="city-feature">
						<ion-icon name="person-sharp" class="icon-small"></ion-icon>
						1600+ happy eaters
					</div>
					<div class="city-feature">
			...
			<div class="row">
				<form method="post" action="mailer.php" class="contact-form">
					...
					<div class="row">
						...
						<div class="col span-2-of-3">
							<select name="find-us" id="find-us">
								...
								<option value="add">Advertisment</option>
					...
					<div class="row">
						...
						<div class="col span-2-of-3">
							<input id="submit" class="btn-full" type="submit" value="Send it">
						</div>
					</div>
				</form>
			</div>
		...
		<footer>
			...
			<div class="row">
				<p>Copyright &copy; 2019 by Milosminda. All rights reserved.</p>
			</div>
		</footer>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-176888251-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-176888251-2');
</script>
